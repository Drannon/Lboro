...
\begin{enumerate}
    ...
    \item What negative consequences are likely from interventions in sensitive areas?
        ...
        \end{itemize}
    \item What are the greenhouse gas emitters in the system and in current initiatives, and how can they be mitigated?
        \begin{itemize}
...
Beyond that, it distilling the root definitions down to a diagrammatic form has proved helpful as a reference.
...
This is monitored by regulators, which prompts lowering of abstraction limits and increases of minimum flow limits to water companies.
...
Further fidelity could be achieved, but for the purposes of insight a high-level investigation is sufficient.
...
The first is a sort of "shifting the burden", concerning leaks, new infrastructure and repairing old infrastructure.
...
This can be remedied with better infrastructure, efforts to reduce demand, or even a reduction in emissions and climate change in the long term, but it is easier to simply pressure these limits to be lowered so that more water can be abstracted (R4).
...
The Environment Agency can only use powers granted to it by legislation (such as abstraction licenses) to manage the management catchment.
...
This investigation leads to these five recommendations to the Environment Agency, and to HM Government, to improve water resilience in the Test and Itchen Management Catchment Area:
...
\begin{enumerate}
    ...
    \item HM Government should grant the Environment Agency more instruments to hold water companies accountable, and to give customers agency.
        There is a current plan to integrate parts of the Environment Agency and Ofwat, however the whole water regulation apparatus could be integrated into DEFRA to give it influence on policy and legislation. They
        This body would also be able to remove reliance on fines, which in many cases incentivise the behaviour they try to punish, and they could introduce limits (not targets, routinely broken by Southern Water\cite{SouthernWaterServicesLimited2025}) on supply continuity and on emissions.
    ...
    \item The Environment Agency should continue the Catchment-Based Approach and further integrate it into the regulation apparatus.
        The approach engages water companies with the Water Industry National Environment Programme and the Water Industry Strategic Environmental Requirements\cite{CatchmentBasedApproach2025}, and Catchment Partnerships are a vector by which communities can be involved with River Basin Management Plans\cite{DEFRA2013}.
        It lays the foundation for more community-driven management of the rivers, and allows the views of all shareholders to be captured effectively.
    ...
    \item HM Government should consider taking Southern Water under public ownership, or operate it as a QUANGO.
        ...
        Additionally, taking it under public ownership removes foreign parties' control from the water supply, bolstering national security.
        As there is no choice to the consumer as to who supplies their water, this proves a prime target for nationalisation - the main benefit of privatisation, competition, does not exist.
    \item The Environment Agency should be proactive in the education of the general public on the impact that their demand for water, food, and energy has on water resilience.
        ...
        Encouraging the public to take a holistic approach to conservation and greenhouse gas emission could highlight the interconnectedness of the system and how decisions in all aspects of life can affect water quality and quantity.
